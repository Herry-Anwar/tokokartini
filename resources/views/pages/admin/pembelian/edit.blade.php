...
@section('content')
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow">
            <div class="card-body">
              <form action="{{route('pembelian.update', $items->kode_beli)}}" method="POST" >
                @csrf
                @method('PUT')
                  <div class="form-group">
                    <label for="kode_beli">Kode Pembelian</label>
                    <input type="number" disabled class="form-control" name="kode_beli" placeholder="Kode Pembelian" 
                    value="{{$items->kode_beli}}">
                  </div>
                  <div class="form-group">
                    <label for="nama">Data Barang</label>
                        <select disabled name="nama" id="nama" class="form-control">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="supplier" placeholder="Nama Supplier" value="{{$items->supplier}}">
                  </div>
